...
class IrrigationNode(models.Model):
    ...
    battery_level = models.FloatField(null=True, blank=True, help_text="Battery level in %")
    ...
    class Meta:
        ordering = ['-created_at']
        unique_together = ['project', 'device_id']
...
from sensors.models import IrrigationNode  # adjust import path
class SensorReading(models.Model):
    ...
    salinity      = models.FloatField(null=True, blank=True, help_text="Salinity level")
